...
export default function App() {
  ...
  // El contenido de la vista, aplicando el paywall si la feature es de pago.
    ...
    <div className={"layout" + (menuOpen ? " open" : "")}>
      ...
      <div className="main-col">
        ...
        <main className="content">
          ...
          {data && sel && <MatchDetail m={sel} bankroll={bank} onBack={() => setSel(null)} onTeam={openTeam} players={data.players} plan={plan} onUpgrade={() => { setSel(null); goto("planes"); }} />}
          ...
          {data && !sel && !teamSel && (
            <>
              ...
              {!gated && view === "jugadores" && <Jugadores players={data.players} />}
