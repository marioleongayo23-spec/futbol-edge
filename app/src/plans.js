...
// La monetización solo "aprieta" cuando está realmente configurada: hay algún
// enlace de pago de Stripe, o se ha fijado un plan por defecto explícito. Si no,
// la app queda ABIERTA (todo desbloqueado) para no dejar features muertas tras
// un paywall que aún no se puede pagar. Los planes y la página de precios se ven
// igual; solo cambia si se bloquea o no.
export const MONETIZATION_ON =
  Boolean(
    import.meta.env?.VITE_STRIPE_PRO_MONTH ||
    import.meta.env?.VITE_STRIPE_PRO_YEAR ||
    import.meta.env?.VITE_STRIPE_VIP_MONTH ||
    import.meta.env?.VITE_STRIPE_VIP_YEAR ||
    import.meta.env?.VITE_DEFAULT_PLAN,
  );

// Resuelve el plan efectivo de una sesión. El dueño (VITE_ALLOWED_EMAIL) siempre
// es VIP; si Supabase trae un plan en los metadatos, manda; si la monetización no
// está configurada, todo abierto (VIP); si lo está, el plan por defecto. Nunca
// lanza aunque no haya sesión.
